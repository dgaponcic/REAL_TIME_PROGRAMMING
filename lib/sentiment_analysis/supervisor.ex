defmodule SentimentAnalysis.Supervisor do
    use DynamicSupervisor

    def start_link() do
        supervisor = DynamicSupervisor.start_link(__MODULE__, :ok, name: __MODULE__)
        SentimentAnalysis.Supervisor.start_child(4)
        supervisor
    end
    ...
    def start_child(n) do
        ...
        DynamicSupervisor.start_child(__MODULE__, {SentimentAnalysis.Worker, index})
